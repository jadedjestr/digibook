...
/**
 * Glass transparency, mirroring the control iOS 27 added to Settings.
 *
 * The slider writes a single CSS variable that every glass surface reads, so
 * dragging it re-tints the whole app live — including this card. That is the
 * point: the setting is previewed on the surface you are adjusting.
 */
