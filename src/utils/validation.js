...
export const validateAmount = (amount) => {
  ...
  if (!CURRENCY_REGEX.test(cleanAmount)) {
    return { isValid: false, error: 'Please enter a valid amount (e.g., 10.50)' };
  }
...
export const validateCreditCard = (cardData) => {
  ...
  return {
    ...
    sanitizedData: {
      ...
      creditLimit: limitValidation.isValid ? limitValidation.value : cardData.creditLimit,
      interestRate: rate,
      dueDate: dueDateValidation.isValid ? dueDateValidation.value : cardData.dueDate,
      minimumPayment: minPaymentValidation.isValid ? minPaymentValidation.value : cardData.minimumPayment,
    },
  };
};
