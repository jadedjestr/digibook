...
const EnhancedCreditCard = ({ 
  ...
  const utilization = card.utilization || ((card.balance / card.creditLimit) * 100);
    ...
    >
      ...
      <div className="payment-section">
        <div className={`payment-item ${isPaymentUrgent ? 'urgent' : ''}`}>
          ...
          <div className={`payment-countdown ${isPaymentUrgent ? 'urgent' : ''}`}>
      ...
      <div className="additional-info">
        <div className="additional-info-item">
          ...
          <span>{card.statementClosingDate ? formatDate(card.statementClosingDate) : 'N/A'}</span>
        </div>
        <div className="additional-info-item">
