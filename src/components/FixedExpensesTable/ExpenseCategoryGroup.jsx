...
import { ChevronDown, ChevronRight, Home, Zap, Shield, Car, Smartphone, CreditCard, Stethoscope, GraduationCap, Package } from 'lucide-react';
...
const ExpenseCategoryGroup = ({
  ...
  const paidCount = categoryExpenses.filter(expense => expense.status === 'paid').length;
