  ...
  >
    <defs>
      <radialGradient id='shieldGlow' cx='50%' cy='30%' r='70%'>
        <stop offset='0%' stopColor='rgba(240, 192, 155,0.3)' />
        <stop offset='100%' stopColor='rgba(224, 145, 92,0.05)' />
      </radialGradient>
    </defs>
    <path
      d='M44 10 L66 20 L66 42 Q66 58 44 68 Q22 58 22 42 L22 20 Z'
      fill='url(#shieldGlow)'
      stroke='rgba(224, 145, 92,0.45)'
      strokeWidth='1'
    ...
    <path
      ...
      strokeLinejoin='round'
    />
    <circle cx='32' cy='16' r='2' fill='rgba(224, 145, 92,0.3)' />
    <circle cx='56' cy='16' r='2' fill='rgba(224, 145, 92,0.3)' />
    <circle cx='22' cy='28' r='1.5' fill='rgba(224, 145, 92,0.2)' />
    <circle cx='66' cy='28' r='1.5' fill='rgba(224, 145, 92,0.2)' />
  </svg>
);
