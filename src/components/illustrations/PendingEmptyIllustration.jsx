  ...
  >
    <defs>
      <radialGradient id='sandGlow' cx='50%' cy='20%' r='60%'>
        <stop offset='0%' stopColor='rgba(240, 192, 155,0.25)' />
        <stop offset='100%' stopColor='rgba(224, 145, 92,0.0)' />
      </radialGradient>
    </defs>
    <path
    ...
    <ellipse
      ...
      strokeWidth='0.5'
    />
    <ellipse cx='44' cy='19' rx='7' ry='2.5' fill='rgba(240, 192, 155,0.2)' />
    <ellipse
      cx='44'
      cy='18.5'
      rx='4'
      ry='1.5'
      fill='rgba(240, 192, 155,0.35)'
    />
    <circle cx='44' cy='36' r='1.5' fill='rgba(224, 145, 92,0.4)' />
    <circle cx='44' cy='41' r='1' fill='rgba(224, 145, 92,0.25)' />
    <circle cx='44' cy='45' r='0.75' fill='rgba(224, 145, 92,0.15)' />
    <ellipse
      cx='44'
      cy='62'
      rx='6'
      ry='2'
      fill='rgba(224, 145, 92,0.06)'
